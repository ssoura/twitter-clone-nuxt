...
const whoToFollowItems = ref([
    {
        name: 'sourabh shukla',
        handle: '@ssh',
        image: 'https://images.unsplash.com/photo-1529258297641-785a413968af?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2669&q=80'
    },
    {
        name: 'sourabh shukla',
        handle: '@ssh',
